			...
			<div class="col-sm-12">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<h2 class="form-header black333">Register as an instructor</h2>
						<form class="el-form-2" id="el-form-2">
							...
							<div class="top20">
								<input type="text" class="border1 borderddd form-1-style2 border1 b-radius3" placeholder="driving school name" />
							</div>
