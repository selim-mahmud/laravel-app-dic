        ...
        <div class="col-md-12">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <span class="panel-title">List of all approving reviews</span>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach($reviews as $review)
                                    <tr>
                                        ...
                                        <td class="alert-warning"><div>{{$review->approved}}</div></td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <a href="{{url('staff/reviews/approve', [$review->id])}}" class="btn btn-success pull-right" onClick="javascript: return confirm('Are you sure to approve!');">Approve</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
