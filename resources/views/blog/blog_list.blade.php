                            ...
                            <article>
                                <div class="first-post">
                                    <div class="first-pict">
                                        <img src="{{asset($publishedPost->feature_image)}}" alt="wd">
                                    ...
                                    <div class="color777">
                                        ...
                                        <div class="">
                                            <a href="{{url('blog', [$publishedPost->slug])}}">
                                                <div class="readmore-btn b-radius3 color777 top20 uppercase">read more <i
                                                            class="fa fa-angle-double-right" style="margin-left: 5px;"></i>
                                                </div>
                                            </a>
                                            <div class="clearfix"></div>
                                        </div>
